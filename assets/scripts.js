...
function filterList() {
	for (var t = [], e = [], n = [], r = [], i = 0; i < checkCategory.length; i += 1)
		if (checkCategory[i].checked) {
			var a = checkCategory[i].value;
			t.push(a)
		}
	for (var s = 0; s < checkDuration.length; s += 1)
		if (checkDuration[s].checked) {
			var o = checkDuration[s].value;
			e.push(o)
		}
	for (var l = 0; l < checkType.length; l += 1)
		if (checkType[l].checked) {
			var u = checkType[l].value;
			n.push(u)
		}
	for (var c = 0; c < checkOrigin.length; c += 1)
		if (checkOrigin[c].checked) {
			var f = checkOrigin[c].value;
			r.push(f)
		}
	t.length + e.length + n.length + r.length > 0 ? recipeList.filter(
		function (i) {
	...
	var e = {
		...
		u = function (e, n, r, i) {
			...
			return a = Math.max(a - n - r, 0), i && (a = Math.min(a, l() - t.innerHeight)), a
		},
		c = function (t) {
		...
		d = function (e) {
			if (history.replaceState && e.updateURL && !history.state) {
				...
				n = n || t.pageYOffset, history.replaceState({
	...
	return function (a, g) {
		...
		O.cancelScroll = function (t) {
			...
			if (d || g) {
				...
				var b, S, x, w = c(C),
					...
					M = function (e, r) {
						var a = t.pageYOffset;
						if (e == r || a == r || (y < r && t.innerHeight + a) >= I) return O.cancelScroll(!0), m(n, r, d), v("scrollStop", s, n, i), b = null, E = null, !0
					},
					B = function e(n) {
						b || (b = n), L += n - b, S = 0 === k ? 0 : L / k, S = S > 1 ? 1 : S, x = y + N * o(s, S), t.scrollTo(0, Math.floor(x)), M(x, A) || (E = t.requestAnimationFrame(e), b = n)
					};
				0 === t.pageYOffset && t.scrollTo(0, 0), h(n, d, s), v("scrollStart", s, n, i), O.cancelScroll(!0), t.requestAnimationFrame(B)
			}
		};
		var x = function (e) {
				if (!i() && 0 === e.button && !e.metaKey && !e.ctrlKey && "closest" in e.target && (b = e.target.closest(a)) && "a" === b.tagName.toLowerCase() && !e.target.closest(p.ignore) && b.hostname === t.location.hostname && b.pathname === t.location.pathname && /#/.test(b.href)) {
					...
					r = r || "#top" !== n ? r : document.documentElement, r && (e.preventDefault(), d(p), O.animateScroll(r, b))
				}
			},
			w = function (t) {
		...
		return O.destroy = function () {
			...
			O.destroy(), p = r(e, i || {}), C = p.header ? document.querySelector(p.header) : null, document.addEventListener("click", x, !1), p.updateURL && p.popstate && t.addEventListener("popstate", w, !1)
		}, O.init(g), O
	}
});
...
var List = function (t) {
		...
		var n = function (t, e, n) {
			...
			i = function (t, e, n) {
				for (var r = [], i = t.getElementsByTagName("*"), a = i.length, s = new RegExp("(^|\\s)" + e + "(\\s|$)"), o = 0, l = 0; o < a; o++)
		...
		t.exports = function () {
			return function (t, e, a, s) {
				return s = s || {}, s.test && s.getElementsByClassName || !s.test && document.getElementsByClassName ? n(t, e, a) : s.test && s.querySelector || !s.test && document.querySelector ? r(t, e, a) : i(t, e, a)
			}
		}()
	}, function (t, e) {
		var n = [].indexOf;
		...
		t.exports = function (t) {
			return function e(n, r, i) {
				var a = n.splice(0, 50);
				i = i || [], i = i.concat(t.add(a)), n.length > 0 ? setTimeout(function () {
					e(n, r, i)
				}, 1) : (t.update(), r(i))
			}
		}
			...
			var n = {
				...
				item: function (t, e, r) {
					for (var i = !0, a = 0; a < r.length; a++) {
						for (var s = !1, o = 0, l = e.length; o < l; o++) n.values(t.values(), e[o], r[a]) && (s = !0);
						s || (i = !1)
					}
					t.found = i
				},
			...
			h = {
				start: function () {
					m.listClass = "list", m.searchClass = "search", m.sortClass = "sort", m.page = 1e4, m.i = 1, m.items = [], m.visibleItems = [], m.matchingItems = [], m.searched = !1, m.filtered = !1, m.searchColumns = void 0, m.handlers = {
						...
						getAttribute: c,
						toArray: f
					}, m.utils.extend(m, e), m.listContainer = "string" == typeof t ? document.getElementById(t) : t, m.listContainer && (m.list = i(m.listContainer, m.listClass, !0), m.parse = n(13)(m), m.templater = n(16)(m), m.search = n(14)(m), m.filter = n(9)(m), m.sort = n(15)(m), m.fuzzySearch = n(10)(m, e.fuzzySearch), this.handlers(), this.items(), this.pagination(), m.update())
				},
				handlers: function () {
				...
				pagination: function () {
					if (void 0 !== e.pagination) {
						...
						for (var t = 0, n = e.pagination.length; t < n; t++) p(e.pagination[t])
					}
				}
				...
				if (0 !== t.length) {
					...
					for (var i = 0, a = t.length; i < a; i++) {
						var s = null;
						r = m.items.length > m.page, s = new v(t[i], void 0, r), m.items.push(s), n.push(s)
					}
					return m.update(), n
				}
				...
				for (var r = 0, i = 0, a = m.items.length; i < a; i++) m.items[i].values()[t] == e && (m.templater.remove(m.items[i], n), m.items.splice(i, 1), a--, i--, r++);
				return m.update(), r
				...
				filter: function () {
					for (var t = m.items, e = t.length; e--;) t[e].filtered = !1;
					return m
				},
				search: function () {
					for (var t = m.items, e = t.length; e--;) t[e].found = !1;
					return m
				}
		...
		t.exports = function (t) {
			var e = n(2)(t),
				r = function (t) {
					for (var e = t.childNodes, n = [], r = 0, i = e.length; r < i; r++) void 0 === e[r].data && n.push(e[r]);
					return n
				},
				i = function (n, r) {
					for (var i = 0, a = n.length; i < a; i++) t.items.push(new e(r, n[i]))
				},
				a = function e(n, r) {
					var a = n.splice(0, 50);
					i(a, r), n.length > 0 ? setTimeout(function () {
						e(n, r)
		...
		t.exports = function (t) {
			var e, n, r, i, a = {
					...
					setSearchString: function (e) {
						e = t.utils.toString(e).toLowerCase(), e = e.replace(/[-[\]{}()*+?.,\\^$|#]/g, "\\$&"), r = e
					},
					toArray: function (t) {
						var e = [];
				...
				o = function (e) {
					return t.trigger("searchStart"), a.resetList(), a.setSearchString(e), a.setOptions(arguments), a.setColumns(), "" === r ? s.reset() : (t.searched = !0, i ? i(r, n) : s.list()), t.update(), t.trigger("searchComplete"), t.visibleItems
				};
		...
		t.exports = function (t) {
			var e = {
				...
				n = function () {
					...
					r ? (n.valueName = t.utils.getAttribute(r, "data-sort"), e.getInSensitive(r, n), n.order = e.getOrder(r)) : (n = arguments[1] || n, n.valueName = arguments[0], n.order = n.order || "asc", n.insensitive = void 0 === n.insensitive || n.insensitive), e.clear(), e.setOrder(n);
					...
					i = a ? function (t, e) {
						...
						return i.alphabet = t.alphabet || n.alphabet || void 0, !i.alphabet && n.insensitive && (i = t.utils.naturalSort.caseInsensitive), i(e.values()[n.valueName], r.values()[n.valueName]) * s
		...
		var n = function (t) {
			...
			this.clearSourceItem = function (e, n) {
					for (var r = 0, i = n.length; r < i; r++) {
						var a;
						if (n[r].data)
							for (var s = 0, o = n[r].data.length; s < o; s++) e.setAttribute("data-" + n[r].data[s], "");
					...
					if (void 0 === e) {
						for (var n = t.list.childNodes, r = 0, i = n.length; r < i; r++)
							if (void 0 === n[r].data) return n[r].cloneNode(!0)
					} else {
						if (/<tr[\s>]/g.exec(e)) {
					...
					for (var i = {}, a = 0, s = r.length; a < s; a++) {
						var o;
						if (r[a].data)
							for (var l = 0, u = r[a].data.length; l < u; l++) i[r[a].data[l]] = t.utils.getAttribute(e.elm, "data-" + r[a].data[l]);
					...
					var i = function (e) {
						for (var n = 0, r = t.valueNames.length; n < r; n++)
							if (t.valueNames[n].data) {
								for (var i = t.valueNames[n].data, a = 0, s = i.length; a < s; a++)
									if (i[a] === e) return {
										data: e
									}
							} else {
					...
					if (!n.create(e))
						for (var a in r) r.hasOwnProperty(a) && function (n, r) {
							var a, s = i(n);
		...
		t.exports = function (t, e) {
			...
			if (!n)
				for (var r = t.attributes, i = r.length, a = 0; a < i; a++) void 0 !== e[a] && e[a].nodeName === e && (n = e[a].nodeValue);
			return n
		}
	}, function (t, e, n) {
		function r(t) {
		...
		function i(t, e) {
			for (var n = (t += "").length, i = (e += "").length, a = 0, l = 0; a < n && l < i;) {
				...
				if (r(u)) {
					if (!r(c)) return u - c;
					for (var f = a, d = l; 48 === u && ++f < n;) u = t.charCodeAt(f);
					for (; 48 === c && ++d < i;) c = e.charCodeAt(d);
					for (var h = f, m = d; h < n && r(t.charCodeAt(h));) ++h;
					for (; m < i && r(e.charCodeAt(m));) ++m;
					var v = h - f - m + d;
					if (v) return v;
					for (; f < h;)
						if (v = t.charCodeAt(f++) - e.charCodeAt(d++)) return v;
					a = h, l = m
				} else {
					if (u !== c) return u < o && c < o && -1 !== s[u] && -1 !== s[c] ? s[u] - s[c] : u - c;
					++a, ++l
				}
			}
			return n - i
		...
		i.caseInsensitive = i.i = function (t, e) {
			...
			alphabet: {
				...
				set: function (t) {
					...
					var e = 0;
					if (a)
						for (; e < a.length; e++) s[a.charCodeAt(e)] = e;
		...
		t.exports = function (t, e, n) {
			...
			for (var d, h, m, v = e.length + t.length, g = 0; g < e.length; g++) {
				for (d = 0, h = v; d < h;) r(g, o + h) <= u ? d = h : v = h, h = Math.floor((v - d) / 2 + d);
				v = h;
	...
	checkType = document.getElementsByClassName("js-type"),
	checkOrigin = document.getElementsByClassName("js-origin"),
	checkBoxes = document.getElementsByClassName("searchbar-checkbox");
if (checkBoxes)
	for (var k = 0; k < checkBoxes.length; k += 1) checkBoxes[k].addEventListener("change", filterList);
